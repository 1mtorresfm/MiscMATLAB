...
% Last Modified by GUIDE v2.5 28-Jul-2008 17:25:35
...
% --- Otherwise, executes on mouse press in 5 pixel border or over startstopButton.
function startstopButton_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to startstopButton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on key press with focus on startstopButton and none of its controls.
function startstopButton_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to startstopButton (see GCBO)
